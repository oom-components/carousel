...
describe('Carousel testing', function () {
    context('Init', function () {
        ...
        it('returns slides properly', function () {
            ...
            expect(carousel.getSlide('first')).to.equal(element.firstElementChild);
            expect(carousel.getSlide('last')).to.equal(element.lastElementChild);
    ...
    context('Move', function () {
        ...
        it('goes to the end', function () {
            ...
            expect(carousel.getSlide('current')).to.equal(element.lastElementChild);
        })
